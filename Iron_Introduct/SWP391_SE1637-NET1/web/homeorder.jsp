...
<html>
    <head>
        <title>Trade Assurance Orders</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="/SWP391_SE1637-NET/HomeOrderController">ORDER</a></li>
                        <li>
            ...
            <div class="row">
                            ...
                            <table class="table table-borderless table-shopping-cart">
                                <thead class="text-muted">
                                    <tr class="small text-uppercase">
                                        <th scope="col">List Orders</th>
                                        <th scope="col" class="text-right d-none d-md-block" width="200"></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <c:choose>
                                        <c:when test="${requestScope.listOrders == null || requestScope.listOrders.size() == 0 || sessionScope.customer == null}">
                                        <h3 style="color: rgb(150,150,155); padding: 5px">Orderlist is empty!</h3>
                                    </c:when>
                                    <c:otherwise>

                                        <c:forEach items="${listOrders}" var="CLO">
                                            <tr>
                                                <td>
                                                    <figure class="itemside align-items-center">
                                                        <div class="aside" style="display: block">
                                                            ...
                                                            <P >${CLO.orderId}</p></div>
                                                        <figcaption class="info" style="display: block; padding-left: 50px">
                                                ...
                                                <td class="text-right d-none d-md-block">
                                                    <a href="HomeOrderDetailController?orderId=${CLO.orderId}" class="btn btn-light" data-abc="true">
                                                        Detail
                                                    </a>
                                                </td>
                                            </tr>
                ...
                <aside class="col-lg-3">
                    <div class="card mb-3">
                        <div class="card-body">
                            <form>
                                <label>Name: ${sessionScope.customer.cusName}</label>
