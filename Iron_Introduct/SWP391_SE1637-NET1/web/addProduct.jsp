                            ...
                            <form action="AddProductController" method="post"  enctype="multipart/form-data" >
                                <div class="modal-body">
                                    ...
                                    <div class="form-outline mb-3">
                                        ...
                                        <input type="text" hidden="" id="url" class="form-control form-control-lg" name="url" />
                                    ...
                                    <div class="form-outline mb-3">
                                        <label class="form-label" for="img3Example"> Image library <span style="color: red; font-weight: bold">*</span></label>
                                    ...
                                    <div class="form-outline mb-3">
                                        <label class="form-label" for="img3Example">Size <span style="color: red; font-weight: bold">*</span></label>
                                        <input type="text" id="kichCo" class="form-control form-control-lg"
                                               required name="kichCo" />
                                    </div>  
                                    <div class="form-outline mb-3">
                                        <label class="form-label" for="img3Example">Weight</label>
