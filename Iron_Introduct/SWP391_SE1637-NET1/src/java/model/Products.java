...
public class Products {
    ...
    public Products(String pName, String imgPath, String description, String kichCo, String trongLuong, String price) {
        this.pName = pName;
    ...
    public Products(int pId, String pName, String imgPath, String kichCo, String trongLuong, String price) {
        this.pId = pId;
        this.pName = pName;
        this.imgPath = imgPath;
        this.kichCo = kichCo;
    ...
    public Products(int pId, String pName, String imgPath, String description, int status,  int cateId, String kichCo, String trongLuong, String detailPath, String price ,String url) {
        this.pId = pId;
        this.pName = pName;
        this.imgPath = imgPath;
        this.description = description;
