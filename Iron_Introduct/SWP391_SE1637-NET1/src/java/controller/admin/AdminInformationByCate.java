 ...
 * @author nguye
 */
public class AdminInformationByCate extends HttpServlet {
    ...
    throws ServletException, IOException, SQLException {
        ...
        try {
            ...
            List<Informations> listInfor = new InformationsDAO().getInforByCateId(id);
    ...
    throws ServletException, IOException {
        try {
            ...
            Logger.getLogger(AdminInformationByCate.class.getName()).log(Level.SEVERE, null, ex);
        }
    } 
