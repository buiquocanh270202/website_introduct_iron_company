...
public class EditProductController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean check = new ProductDAO().updateProductURL(pName, imgPath, description, status, cateId, kichCo, trongLuong, detailPath, price, url, pId);
            ProductImgDAO p = new ProductImgDAO();
            String uploadPath = "D:\\Study\\5\\SWP\\SWP391_SE1637-NET1\\web\\files";
            ...
            if (fileParts != null) {
                ...
                String basePath = "D:\\Study\\5\\SWP\\SWP391_SE1637-NET1\\web\\files";
                
                for (ProductImg productImg : p.getProductImgLink(pId)) {
