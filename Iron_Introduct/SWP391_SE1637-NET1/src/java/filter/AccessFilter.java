...
//        adminList.add("CartController");
//        adminList.add("exportProducts");
//        adminList.add("HomeListInforByCate");
//        adminList.add("AddToCartController");
//        adminList.add("CustomerInforController");
//        adminList.add("ExportToExcelController_orderdetailview");
//        adminList.add("HomeProductDetailController");
//
...
//        adminList.add("HomeCategoryController");
//        adminList.add("AdminInformationByCate");
//        adminList.add("DeleteMultiInformation");
//        adminList.add("AdminOrderController");
//        adminList.add("AdminSearchOrderController");
//        adminList.add("AdminOrderDetailController");
//
//        adminList.add("AdminOrderController");
...
//        adminList.add("UploadFileServlet");
        ...
        managerList.add("AdminHomeController");
        managerList.add("AdminAccountController");
        managerList.add("InsertAccountController");
        managerList.add("UpdateAccountController");
...
//        managerList.add("AdminInformationByCate");
//        
//        managerList.add("AdminOrderController");
//        managerList.add("AdminSearchOrderController");
//        managerList.add("AdminOrderDetailController");
//        managerList.add("AdminOrderController");
//        
...
//        guestList.add("HomeProductDetailController");
//        guestList.add("HomeOrderController");
//        guestList.add("HomeOrderDetailController");
//        guestList.add("CustomerReorderController");
//        guestList.add("Test");

        guestList.add("AdminHomeController");
        guestList.add("AdminAccountController");
        guestList.add("InsertAccountController");
        guestList.add("UpdateAccountController");
        guestList.add("AdminCategoryController");

        guestList.add("AdminProductController");
        guestList.add("InsertProductController");
        guestList.add("AddProductController");
        guestList.add("EditProductController");
        guestList.add("UpdateProductController");

        guestList.add("UpdateCategoryController");
        guestList.add("UpdateInforCateController");
        guestList.add("UpdateInforController");
        guestList.add("AdminInformationCategoryController");
        guestList.add("AdminInformationController");
        guestList.add("DeleteInforController");
        guestList.add("InsertInforController");
        guestList.add("AdminInformationByCate");
        guestList.add("DeleteMultiInformation");
        guestList.add("AdminOrderController");
        guestList.add("AdminSearchOrderController");
        guestList.add("AdminOrderDetailController");
        guestList.add("supporter.jsp");
        guestList.add("AdminOrderController");
        guestList.add("ChangeUserInfo");
        
        

        supporterList = new ArrayList<>();

        supporterList.add("AdminHomeController");
        supporterList.add("AdminAccountController");
        supporterList.add("InsertAccountController");
        supporterList.add("UpdateAccountController");
        supporterList.add("AdminCategoryController");

        supporterList.add("AdminProductController");
        supporterList.add("InsertProductController");
        supporterList.add("AddProductController");
        supporterList.add("EditProductController");
        supporterList.add("UpdateProductController");

        supporterList.add("UpdateCategoryController");
        supporterList.add("UpdateInforCateController");
        supporterList.add("UpdateInforController");
        supporterList.add("AdminInformationCategoryController");
        supporterList.add("AdminInformationController");
        supporterList.add("DeleteInforController");
        supporterList.add("InsertInforController");
        supporterList.add("AdminInformationByCate");
        supporterList.add("DeleteMultiInformation");
        supporterList.add("AdminOrderController");
        supporterList.add("AdminSearchOrderController");
        supporterList.add("AdminOrderDetailController");
        
        

        check = new ArrayList<>();
        check.add("AdminHomeController");
        check.add("AdminAccountController");
        check.add("InsertAccountController");
        check.add("UpdateAccountController");
        check.add("AdminCategoryController");

        check.add("AdminProductController");
        check.add("InsertProductController");
        check.add("AddProductController");
        check.add("EditProductController");
        check.add("UpdateProductController");

        check.add("UpdateCategoryController");
        check.add("UpdateInforCateController");
        check.add("UpdateInforController");
        check.add("AdminInformationCategoryController");
        check.add("AdminInformationController");
        check.add("DeleteInforController");
        check.add("InsertInforController");
        check.add("AdminInformationByCate");
        check.add("AdminOrderController");
    }
...
//                    if (adminList.contains(resource)) {
                    chain.doFilter(request, response);
//                    } else {
//                         httpResponse.sendRedirect("AdminHomeController");
//                    }
                    ...
                    if (!supporterList.contains(resource)) {
                        ...
                        httpResponse.sendRedirect("AdminOrderController");
                    }
                } else {
