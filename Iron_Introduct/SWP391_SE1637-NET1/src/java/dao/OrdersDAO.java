...
public class OrdersDAO {
    ...
    private static final String GET_ORDERS_BY_ARRANGE_TIME = "SELECT orderId,  orderDate , status, phone, cusId FROM swp_gr01.order WHERE  orderDate  BETWEEN ? AND ?;";
...
//    }
    ...
    public List<Orders> getOrdersByPeriodTime(String from, String to) throws SQLException {
        ...
        try {
            ...
            if (conn != null) {
                psm = conn.prepareStatement(GET_ORDERS_BY_ARRANGE_TIME); //orderId, orderDate, status, phone, cusId
   ...
   public int insertOrder(int cusId, Map<Integer, Cart> carts, String name, String phone, String email) throws SQLException {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        System.out.println("Hello" + rs);
         ...
         List<Orders> listOrders = new OrdersDAO().getOrdersByPeriodTime( "2023-03-05", "2023-03-06");
         for (Orders listOrder : listOrders) {
             System.out.println("Non " + listOrder);
        }
